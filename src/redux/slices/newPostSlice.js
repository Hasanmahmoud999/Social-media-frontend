...
export const { uploadNewPostStart, uploadNewPostSuccess, uploadNewPostFailur,retreivingPostStart,retreivingPostSuccess,retreivingPostFailur } = newPostSlice.actions;
